...
# load video
video_path = "\LPR\License_plate_recognition_system\yolo\sample_video.mp4"
...
for car_id in np.unique(results["car_id"]):
    ...
    # Set the video frame to the one where the license plate was detected
...
while ret:
    ...
    if ret:
        ...
        # Inserting License Plate and Text
